...
![Original US Fencing Divisions Chart](/simeon-dataviz-portfolio/visualization/original_graphic.png)
...
![Solution Workflow Diagram](/simeon-dataviz-portfolio/visualization/Solution Workflow Diagram.png)
...
<div style="width: 100%; height: 800px; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; margin: 20px 0;">
  <iframe 
    src="/simeon-dataviz-portfolio/visualization-build/index.html" 
    width="100%" 
    height="100%"
    frameborder="0"
    style="border: none;"
...
[View full screen →](/simeon-dataviz-portfolio/visualization-build/index.html)
